          ...
          <div class="card-body">
            ...
            @endif
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  <input id="nome" type="text" class="form-control @error('name') is-invalid @enderror"
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  <input id="contacto" type="contacto" class="form-control @error('contacto') is-invalid @enderror" name="contacto"
